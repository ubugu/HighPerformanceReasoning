...
class TripleSorter2
{
	...
	public:
		...
		MGPU_DEVICE bool operator() (tripleContainer<int> a, tripleContainer<int> b) {			
			/*int tripleB[3];
			tripleB[0] = b.subject;
			tripleB[1] = b.predicate;
			tripleB[2] = b.object;
			
		/*	int tripleA[3];
			tripleA[0] = a.subject;
			tripleA[1] = a.predicate;
			tripleA[2] = a.object;
			*/
			...
			mask1[0] = maskA[0];
			mask1[1] = maskA[1];
			mask1[2] = maskA[2];<launch_pa<launch_params_t<128, 4>>rams_t<128, 4>>
			*/
			...
			/*<launch_params_t<128, 4>>
			if ((maskA[1] != -1) && (tripleA[0] == tripleB[0]) && (tripleA[1] < tripleB[1])) {
				return true;
			}
