...
int main(int argc,char *argv[]) 
{
	...
	//Format is: <http://example.org/string/longlong/element/int/553>	
	...
	while (getline(rdfStore,strInput)) {
		...
		outf << "<http://example.org/string/longlong/element/int/" + triple[0] + ">" << " " << "<http://example.org/string/longlong/element/int/" + triple[1] + ">" << " " << "<http://example.org/string/longlong/element/int/" + triple[2] + ">" << " ." << endl; 
	}
}
